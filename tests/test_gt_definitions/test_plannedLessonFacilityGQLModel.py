...
test_reference_facilityplan_lessons = createResolveReferenceTest(tableName='facilityplan_lessons', gqltype='plannedLessonFacilityGQLModel', 
                                                         attributeNames=["id", "name"])

test_query_form_page = createPageTest(tableName="facilityplan_lessons", queryEndpoint="plannedLessonFacilityPage", attributeNames=["id"])

test_query_form_by_id = createByIdTest(
    tableName="facilityplan_lessons", queryEndpoint="plannedLessonFacilityById", attributeNames=["id"]
)
