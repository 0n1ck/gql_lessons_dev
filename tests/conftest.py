...
def LoadersContext(SQLite):
    from gql_lessons.utils.Dataloaders import createLoadersContext
...
def Context(AdminUser, SQLite, LoadersContext, Request):
    from gql_lessons.utils.gql_ug_proxy import get_ug_connection
...
def FastAPIClient(SQLite):
    ...
    import gql_lessons.DBDefinitions

    def ComposeCString():
        return "sqlite+aiosqlite:///:memory:"   
    gql_lessons.DBDefinitions.ComposeConnectionString = ComposeCString
