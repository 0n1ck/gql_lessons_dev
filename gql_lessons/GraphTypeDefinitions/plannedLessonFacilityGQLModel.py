...
@strawberryA.field(description="""Returns a list of lessons by facility""")
...
class PlannedLessonFacilityInsertGQLModel:
    ...
    planlesson_id: Optional[uuid.UUID]

@strawberryA.input
class PlannedLessonFacilityUpdateGQLModel:
    id: Optional[uuid.UUID] = strawberryA.field(description="The ID of the facility", default=None)
...
class PlannedLessonFacilityResultGQLModel:
    id: uuid.UUID = strawberryA.field(description="The ID of the facility", default=None)
...
@strawberryA.mutation(description="Adds a new facility.")
...
@strawberryA.mutation(description="Updates the facility.",)
...
@strawberry.mutation(description="Deletes the facility.")
