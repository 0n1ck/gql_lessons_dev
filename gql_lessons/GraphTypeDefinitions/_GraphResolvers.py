...
@strawberry.field(description="""Length of lesson""")
def resolve_length(self) -> Union[int, None]:
    return self.length
...
#     from gql_lessons.GraphTypeDefinitions.externals import UserGQLModel
...
# @strawberry.field(description="""Plan ID """)
# async def resolve_plan_id(self) -> typing.Optional["UserGQLModel"]:
#     return await resolve_user(self.plan_id)

# @strawberry.field(description="""Facility ID """)
# async def resolve_facility_id(self) -> typing.Optional["UserGQLModel"]:
#     return await resolve_user(self.facility_id)

# @strawberry.field(description="""Planned lesson ID """)
# async def resolve_planlesson_id(self) -> typing.Optional["UserGQLModel"]:
#     return await resolve_user(self.planlesson_id)
