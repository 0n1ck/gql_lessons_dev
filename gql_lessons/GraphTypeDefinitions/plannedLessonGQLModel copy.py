...
# import datetime
# import uuid
# from gql_lessons.utils.Dataloaders import Loaders, getLoadersFromInfo
...
# planned_lesson_by_id = createRootResolver_by_id(PlannedLessonGQLModel, description="Returns project by its id")
# plan_lesson_by_semester = createRootResolver_by_id(PlannedLessonGQLModel, description="Returns project by its id")
# plan_lesson_by_topic = createRootResolver_by_id(PlannedLessonGQLModel, description="Returns project by its id")
# plan_lesson_by_event = createRootResolver_by_id(PlannedLessonGQLModel, description="Returns project by its id")
